    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-2">
            <Link href="/" className="block mb-6 w-fit">
              <Image src="/logo.png" alt="Spotlix" width={240} height={70} className="h-12 w-auto object-contain" />
            </Link>
            ...
            <div className="flex flex-col gap-4 mb-6">
              <div className="flex items-start gap-4">
                ...
                <div className="text-[#B5BECF] text-base font-medium">
                  SPOTLIX IO <span className="text-[#A47CF6] font-semibold">LLC</span>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="text-[#A47CF6] mt-0.5">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="text-[#B5BECF] text-base">support@spotlix.io</div>
              </div>
            </div>
            {/* Social links */}
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-slate-600">© {new Date().getFullYear()} Spotlix. All rights reserved.</p>
          <p className="text-xs text-slate-600">
            Physical Business Intelligence Platform •{" "}
            <Link href="/" className="hover:text-slate-400 transition-colors">spotlix.io</Link>
          </p>
        </div>
      </div>
    </footer>
